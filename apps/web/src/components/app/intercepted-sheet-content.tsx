  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ref={ref}
        // Se o usuário pressionar a tecla ESC, fecha o sheet e volta para a tela anterior
        onEscapeKeyDown={onDimiss}
        // Se o usuário clicar fora do sheet, fecha o sheet e volta para a tela anterior
